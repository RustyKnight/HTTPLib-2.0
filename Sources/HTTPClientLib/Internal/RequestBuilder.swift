...
// Feature 003: replaced configurator: RequestConfigurator? with configuration: DefaultHTTPClient.Configuration (FR-008)
internal enum RequestBuilder {

    /// Assembles a URLRequest ready for dispatch.
    ///
    /// Assembly order (Feature 003, data-model.md):
    ///   Step 1 — DefaultHTTPClient.Configuration transport properties (applied first; FR-005, A-07)
    ...
    static func buildRequest(
        ...
        body: RequestBody?,
        configuration: DefaultHTTPClient.Configuration,    // Feature 003: replaces configurator (FR-008)
